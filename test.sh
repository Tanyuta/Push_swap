...
./push_swap `ruby -e "puts (-99..0).to_a.shuffle.join(' ')"` | wc -l
echo "\n"
echo "\033[1;33mRandom 201 numbers negative + positive\033[0m\n"
./push_swap `ruby -e "puts (-100..100).to_a.shuffle.join(' ')"` | wc -l
echo "\n"
echo "\033[1;33mRandom 501 numbers positive + negative\033[0m\n"
./push_swap `ruby -e "puts (-250..249).to_a.shuffle.join(' ')"` | wc -l
echo "\n"
